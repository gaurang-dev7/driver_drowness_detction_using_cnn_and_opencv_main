...
if __name__ == '__main__':
    ...
    pickle_files = ['closed_eyes.pickle']
    i = 0
    ...
    with open('trained_model_on_closed/model1.json', "w") as json_file:
        json_file.write(model_json)

    print("Save weights to file...")
    model.save_weights('trained_model_on_closed/weight1.h5', overwrite=True)