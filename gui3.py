...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "DRIVER FATIGUE DETECTION SYSTEM (DFD)"))
        self.label.setText(_translate(
            "MainWindow", "DRIVER FATIGUE DETECTION SYSTEM (DFD)"))
        self.pushButton.setText(_translate(
            "MainWindow", "Detction using web cam "))
        self.pushButton_2.setText(_translate(
            "MainWindow", "Detction using Image"))
        self.label_2.setText(_translate(
            "MainWindow", "Path of Image for Detction using Image"))

    # def b2(self):
    #     print("starting_predict_eye")
    #     text = self.lineEdit.text()
    #     print(text)
    #     pe.main(text)

    def b1(self):
        print("starting_drowsy_predict")
        dp.main()
